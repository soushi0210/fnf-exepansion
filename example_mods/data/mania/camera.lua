...
local yy = 310; -- Code to change the position of the camera up or down for the enemy More = Down (They can be negative numbers), Less = Up
local xx2 = 1040; -- Same code as above, but for boyfriend left, right
local yy2 = 390; -- Same code as above, but for boyfriend up, down
local xx3 = 510; -- Same code as above, but for girlfriend left, right
