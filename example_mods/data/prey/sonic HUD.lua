...
function onCreate()
    ...
    setTextFont('sonicScoreText','knuckles-chaotix-nova.ttf')
    ...
    setTextFont('sonicMissesText','knuckles-chaotix-nova.ttf')
    setTextBorder('sonicMissesText',1,'000000')
    setTextAlignment('sonicMissesText','left')

    makeLuaText('sonicTimeText',getSongPosition(),100,getProperty('sonicTimeSprite.x') + getProperty('sonicTimeSprite.width')/1.2,getProperty('sonicTimeSprite.y') - 13)
    setObjectCamera('sonicTimeText','hud')
    scaleObject('sonicTimeText',3,3)
    setTextFont('sonicTimeText','knuckles-chaotix-nova.ttf')
