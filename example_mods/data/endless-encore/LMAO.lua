...
for i = 0,3 do
    setPropertyFromGroup('strumLineNotes', i, 'x', defaultNotePos[i + 1][1] - 15 * math.cos((currentBeat + i*0.1) * math.pi))
end
for i = 4,7 do
    setPropertyFromGroup('strumLineNotes', i, 'x', defaultNotePos[i + 1][1] + 15 * math.cos((currentBeat + i*0.3) * math.pi))
end
for i = 0,7 do
    setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] - 15 * math.cos((currentBeat + i*0.25) * math.pi))
